    ...
    <main className="min-h-screen bg-[var(--color-parchment)] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="p-10 text-center">
          <div className="w-16 h-16 mx-auto bg-[var(--color-obsidian)] rounded-2xl flex items-center justify-center mb-8 shadow-inner">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-[var(--color-parchment)]">
